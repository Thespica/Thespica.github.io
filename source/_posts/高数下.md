...
画出关系图，按照广度优先搜索求导：
$$
\frac{\mathrm{d}z}{\mathrm{d}t}=\frac{\part z}{\part u}\frac{\mathrm{d}u}{\mathrm{d}t}
+\frac{\part z}{\part v}\frac{\mathrm{d}v}{\mathrm{d}t}
$$
...
$z=f(x,y)$，全微分为
$$
\mathrm{d}z=\frac{\part z}{\part x}\mathrm{d}x+\frac{\part z}{\part y}\mathrm{d}y
$$
